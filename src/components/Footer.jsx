    ...
    <div className="footer">
      ...
      <div className="footer-column logo">
        ...
        <p className="company-desc">
          تواصل الأمريكية جروب تعزيز مكانتها في السوق من خلال عقد شراكات استراتيجية جديدة مع مجموعة من الشركات الرائدة
          في مجال المنتجات المنزلية.
        </p>
      </div>
      ...
      <div className="footer-column">
        ...
        <ul>
          ...
          <li>
            <a href="/services">خدمات الصيانة</a>
          </li>
          <li>
